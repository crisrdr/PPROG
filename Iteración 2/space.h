...
/**
 * @brief It sets a new set of objects on the space
 * @author Cristina R
 * 
 * @param space pointer to the space
 * @param set pointer to the set to be setted
 * @return OK if everything goes well or ERROR if there was any problem
 */
STATUS space_set_set(Space *space, Set *set);

/**
 * @brief It gets the set of objects of the space
 * @author Cristina R
 * 
 * @param space pointer to the space
 * @return the set of objects of the space
 */
