...
/**
  * @brief It cleans all the info from a game (except the last command)
  * @author Sofia Garcia
  *
  * @param game a pointer to the game
  * @return OK, if everything goes well or ERROR if there was some mistake 
...
/**
 * @brief It gets the dialogue of the game information
 * @author Sofía 
 * @param game a pointer to the game
 */
...
/**
  * @brief It gets a pointer to a link with a specific ID
  * @author Sofia Garcia
  *
  * @param game a pointer to the game
...
/**
  * @brief It gets a link from the game array from its name.
  * @author Sofia Garcia
  *
  * @param game pointer to the game
...
/**
  * @brief It gets the id of a link from the game array.
  * @author Sofia Garcia
  *
  * @param game pointer to the game
  * @param position position of the link from which we want to obtain its id
