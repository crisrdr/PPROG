...
/**
 * @test Test game_space get id at
 * @pre null pointer to space
 * @post Output == NO_ID
 */
...
/**
 * @test Test game_link get by name
 * @pre null pointer to game
 * @post Output == NULL 
 */
