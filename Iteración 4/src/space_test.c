...
int main(int argc, char** argv) {
  ...
  if (all || test == 27) test1_space_get_sdesc();
  if (all || test == 28) test2_space_get_sdesc();
  if (all || test == 29) test1_space_set_sdesc();
  if (all || test == 30) test2_space_set_sdesc();
  if (all || test == 31) test1_space_get_ldesc();
  if (all || test == 32) test2_space_get_ldesc();
  if (all || test == 33) test1_space_set_ldesc();
  if (all || test == 34) test2_space_set_ldesc();
  if (all || test == 35) test1_space_get_light();
  if (all || test == 36) test2_space_get_light();
...
void test1_space_set_sdesc(){
  Space *s = NULL;
  char *name = "sala";
  PRINT_TEST_RESULT(space_set_sdesc(s, name) == ERROR);
}
...
void test2_space_set_sdesc(){
  ...
  char *name = "sala";
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_sdesc(s, name) == OK);
  space_destroy(s);
}

void test1_space_get_sdesc(){
  Space *s = NULL;
  PRINT_TEST_RESULT(space_get_sdesc(s) == NULL);
}
...
void test1_space_set_ldesc(){
  Space *s = NULL;
  char *name = "sala";
  PRINT_TEST_RESULT(space_set_ldesc(s, name) == ERROR);
}
...
void test2_space_set_ldesc(){
  ...
  char *name = "sala";
  s = space_create(5);
  PRINT_TEST_RESULT(space_set_ldesc(s, name) == OK);
  space_destroy(s);
}

void test1_space_get_ldesc(){
  Space *s = NULL;
  PRINT_TEST_RESULT(space_get_ldesc(s) == NULL);
}
