...
int main(int argc, char** argv){
  ...
  if (argc < 2) {
    ...
    if (all || test == 11) test1_game_get_space_id_at();
    if (all || test == 11) test2_game_get_space_id_at();
    if (all || test == 11) test3_game_get_space_id_at();
    ...
    if (all || test == 49) test1_game_clean();
    if (all || test == 49) test2_game_clean();
    if (all || test == 50) test1_game_is_over();
    if (all || test == 51) test2_game_is_over();
    if (all || test == 25) test1_game_get_dialogue();
    if (all || test == 25) test2_game_get_dialogue();
    ...
    if (all || test == 56) test1_game_get_link();
    if (all || test == 57) test2_game_get_link();
    if (all || test == 57) test3_game_get_link();
    if (all || test == 58) test1_game_get_dest_connection_status();
    if (all || test == 59) test2_game_get_dest_connection_status();
    if (all || test == 56) test1_game_get_link_by_name();
    if (all || test == 56) test2_game_get_link_by_name();
    if (all || test == 56) test3_game_get_link_by_name();
...
void test1_game_get_space_id_at(){
    Game *game = NULL;
    PRINT_TEST_RESULT(game_get_space_id_at(game, 3) == NO_ID);
}
...
void test3_game_get_space_id_at(){
    ...
    game_add_space(game, s3);
    game_add_space(game, s2);
    PRINT_TEST_RESULT(game_get_space_id_at(game, 2) == 6);
    game_destroy(game);
}
...
void test1_game_clean(){
    Game *game = NULL;
    PRINT_TEST_RESULT(game_clean(game) == ERROR);
}

void test2_game_clean(){
    Game *game = NULL;
    game = game_create();
    PRINT_TEST_RESULT(game_clean(game) == OK);
    game_destroy(game);
}
...
void test1_game_get_link(){
    Game *game = NULL;
    PRINT_TEST_RESULT(game_get_link(game, 2) == NULL);
}
...
void test3_game_get_link(){
    ...
    link = link_create(2);
    game_add_link(game, link);
    PRINT_TEST_RESULT(game_get_link(game, 2) == link);
    game_destroy(game);
}
...
void test1_game_get_link_by_name(){
    Game *game = NULL;
    char *name = "pasillo";
    PRINT_TEST_RESULT(game_get_link_by_name(game, name) == NULL);
}
...
void test3_game_get_link_by_name(){
    Game *game = NULL;
    Link *link = NULL;
    char *name = "pasillo";
    game = game_create();
    link = link_create(3);
    link_set_name(link, "pasillo");
    game_add_link(game, link);
    PRINT_TEST_RESULT(game_get_link_by_name(game, name) == link);
    game_destroy(game);
}

void test1_game_get_link_id_at(){
    Game *game = NULL;
    PRINT_TEST_RESULT(game_get_link_id_at(game, 3) == NO_ID);
}
...
void test3_game_get_link_id_at(){
    ...
    l2 = link_create(6);
    l3 = link_create(8);
    game_add_link(game, l1);
    game_add_link(game, l3);
    game_add_link(game, l2);
    PRINT_TEST_RESULT(game_get_link_id_at(game, 2) == 6);
    game_destroy(game);
}