...
/**
 * @test Test funcion for getting the description of the space
 * @pre Try to get the description of a space
 * @post Output == 0
 */
...
/**
 * @test Test funcion for getting the description of the space
 * @pre Try to get the description of a non existing space
 * @post Output == NULL
 */
void test2_space_get_descr();

/**
 * @test Test function for setting the description of the space
 * @pre Try to set the description of a space
 * @post Output == OK
 */
...
/**
 * @test Test function for setting the description of the space
 * @pre Try to set the description of a non existing space
 * @post Output == ERROR
 */
